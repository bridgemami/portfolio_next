    ...
    <main className="min-h-screen relative">
      ...
      >
        <div className="container m-auto">
          <p
            className="text-[300px]  text-[rgb(247,251,253)] md:pl-[50px] px-5 max-w-[750px] w-[100%] overflow-hidden"
          ...
          <div className="" style={{ transform: "translate(0px, -250px)" }}>
            ...
            >
              ...
              full-stack web developer, I constantly priorities 100% client
